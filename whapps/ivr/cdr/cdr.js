winkstart.module('ivr', 'cdr', {
    ...
    function (args) {
        ...
        export_file: function (start_date, end_date) {
            var THIS = this;
            map_users = {},
            parse_duration = function (duration, type) {
                var duration = parseFloat(duration);
            ...
            winkstart.parallel({
                ...
                function (err, results) {
                    ...
                    //tab_data.sort(function(a,b){return a[0]-b[0];});

                    var str = tab_data.join("\n");
                    //alert(str);
                    var csvContent = "data:text/csv;charset=utf-8,From(Caller ID),To(Dialed No),Duration,Hangup Cause,Date\n";
        ...
        activate: function (data) {
            ...
            $('#searchLink3', cdr_html).click(function () {
                var start_date = $('#startDate', cdr_html).val(),
                    end_date = $('#endDate', cdr_html).val(),
                    regex = /^(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.](19|20)\d\d$/;
                ...
                THIS.export_file(start_date, end_date);
            });

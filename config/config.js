    ...
    winkstart.config =  {
            ...
            'default': {
                apps: {
                    voip: {
                        label: 'Hosted PBX',
                        icon: 'phone',
                        api_url: 'http://vinay.viithiisys.com:8000/v1'
                    },
		    ivr: {
                        label: 'IVR',
                        icon: 'phone',
                ...
                available_apps: ['voip', 'cluster', 'userportal', 'accounts', 'developer', 'numbers', 'pbxs', 'ivr'],
        ...
        available_apps: {
            ...
            'ivr': {
                ...
                label: 'IVR',
                icon: 'device',
                desc: 'Creating differnt id`s, callflows ...'
            },
            'cluster': {
                id: 'cluster',
                label: 'Cluster Manager',
